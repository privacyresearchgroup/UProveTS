...
export class Montgomery25519Group implements MultiplicativeGroup {
    ...
    createElementFromBytes(bytes: Uint8Array | number[]): MontgomeryPointWrapper {
        const result = new MontgomeryPointWrapper(this.curve.generator.clone() as MontgomeryCurvePoint)
...
class Curve25519Object implements DLGroup {
    ...
    computeVerifiablyRandomElement(context: Uint8Array | number[]): MontgomeryPointWrapper {
        ...
        const sqrtSolver = cryptoECC.ModularSquareRootSolver(field.modulus.digits /*, rand*/) // no need to set rand when using NIST curves
        ...
        while (y === null) {
            ...
            if (residuesEqual(z.residue, field.zero)) {
                ...
                const tmpY = sqrtSolver.squareRoot(z.m_digits)
                y = (tmpY && field.fromDigits(tmpY)) || null
            }
            count++
        }
        // validate
