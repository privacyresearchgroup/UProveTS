...
import { msrcryptoHashFunctions } from './global'

const msrcryptoSha256 = (function () {
    ...
    function hashBlocks(/*@type(Array)*/ message) {
      ...
      for (block = 0; block < blockCount; block++) {
        ...
        for (i = 0; i < 16; i++) {
          ...
          w[i] = (message[index] << 24) | (message[index + 1] << 16) | (message[index + 2] << 8) | message[index + 3]
        }
...
export default msrcryptoSha256
