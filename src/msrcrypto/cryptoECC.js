...
function MsrcryptoECC() {
  ...
  var curvesData = {
    '256': {
      size: 32,
      data:
        '/////wAAAAEAAAAAAAAAAAAAAAD///////////////9axjXYqjqT57PrvVV2mIa8ZR0GsMxTsPY7zjw+J9JgS/////8AAAAA//////////+85vqtpxeehPO5ysL8YyVRaxfR8uEsQkf4vOblY6RA8ncDfYEt6zOg9KE5RdiYwpZP40Li/hp/m47n60p8D54WK84zV2sxXs7LtkBoN79R9Q==',
    },
    '384': {
      size: 48,
      data:
        '',
    },
    '521': {
      size: 32,
      data:
        '',
    },
  }
  ...
  var EllipticCurvePointFp = function (curve, isInfinity, x, y, z, isInMontgomeryForm) {
    ...
    function equals(/*@type(EllipticCurvePointFp)*/ ellipticCurvePointFp) {
      ...
      if (returnObj.z === null) {
        return (
          cryptoMath.sequenceEqual(returnObj.x, ellipticCurvePointFp.x) &&
  ...
  var EllipticCurveOperatorFp = function (/*@type(EllipticCurveFp)*/ curve) {
    ...
    function generatePrecomputationTableAequalsNeg3(w, generatorPoint) {
      ...
      for (i = 1; i < tableSize; i += 1) {
        var newPoint = EllipticCurvePointFp(curve, false, createArray(s), createArray(s), createArray(s), true)
        t[i] = newPoint
      }
...
const cryptoECC = MsrcryptoECC()
export default cryptoECC
